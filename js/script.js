...
(function () {
  function c() {
    ...
    if (b) {
      ...
      d.innerHTML =
        "window.__CF$cv$params={r:'97cac4e7d6d8c4cb',t:'MTc1NzQ2MzcyNy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/script.js';document.getElementsByTagName('head')[0].appendChild(a);";
